...
namespace Narradia
{
    ...
    void
    Tile::CalculateNormal(Point3F v0, Point3F v1, Point3F v2)
    /*/////////////////////////////////////////////////////*/
    {
    ...
    void
    Tile::RemoveObject(Object *object)
    /*//////////////////////////////*/
    {
    ...
    Tile::GetObjectFromRawPtr(Object *object)
    /*/////////////////////////////////////*/
    {
    ...
    void
    Tile::SetCompanion(std::shared_ptr<Companion> newCompanion)
    /*///////////////////////////////////////////////////////*/
    {
    ...
    void
    Tile::SetMob(std::shared_ptr<Mob> newMob)
    /*/////////////////////////////////////*/
    {
        p->mob = newMob;
    }
    ...
    void
    Tile::AddObject(std::shared_ptr<Object> object)
    /*///////////////////////////////////////////*/
    {
    ...
    void
    Tile::CreateAddObject(std::string_view objectType, int quantity)
    /*////////////////////////////////////////////////////////////*/
    {
    ...
    void
    Tile::CreateAddObject(int objectTypeHash, int quantity)
    /*///////////////////////////////////////////////////*/
    {
    ...
    void
    Tile::SetGroundLayerType(int newGroundLayerType)
    /*////////////////////////////////////////////*/
    {
    ...
    void
    Tile::SetGroundType(int newGroundType)
    /*//////////////////////////////////*/
    {
    ...
    void
    Tile::SetRoofType(int newRoofType)
    /*//////////////////////////////*/
    {
    ...
    void
    Tile::SetElevation(float newElevation)
    /*//////////////////////////////////*/
    {
    ...
    void
    Tile::AlterElevation(float elevationAdd)
    /*////////////////////////////////////*/
    {
    ...
    void
    Tile::SetRedVariation(float newRedVariation)
    /*////////////////////////////////////////*/
    {
    ...
    void
    Tile::SetGreenVariation(float newGreenVariation)
    /*////////////////////////////////////////////*/
    {
    ...
    void
    Tile::SetBlueVariation(float newBlueVariation)
    /*//////////////////////////////////////////*/
    {
    ...
    void
    Tile::AlterRedVariation(float deltaRedVariation)
    /*////////////////////////////////////////////*/
    {
    ...
    void
    Tile::AlterGreenVariation(float deltaGreenVariation)
    /*////////////////////////////////////////////////*/
    {
    ...
    void
    Tile::AlterBlueVariation(float deltaBlueVariation)
    /*//////////////////////////////////////////////*/
    {
    ...
    void
    Tile::SetVertex0(Vertex3F vertex)
    /*/////////////////////////////*/
    {
        p->geometry[0] = vertex;
    }
    ...
    void
    Tile::SetVertex1(Vertex3F vertex)
    /*/////////////////////////////*/
    {
        p->geometry[1] = vertex;
    }
    ...
    void
    Tile::SetVertex2(Vertex3F vertex)
    /*/////////////////////////////*/
    {
        p->geometry[2] = vertex;
    }
    ...
    void
    Tile::SetVertex3(Vertex3F vertex)
    /*/////////////////////////////*/
    {
        p->geometry[3] = vertex;
    }
    ...
    void
    Tile::SetTileRendId(GLuint newTileRendId)
    /*/////////////////////////////////////*/
    {
